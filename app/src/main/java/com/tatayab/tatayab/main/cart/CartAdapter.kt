...
import com.tatayab.tatayab.util.NumbersUtil
 import kotlinx.android.synthetic.main.item_cart_per_countery.view.*
...
class CartAdapter(
    ...
    override fun onBindViewHolder(holder: ProductViewHolder, position: Int) {
        ...
        with(holder) {
            ...
            product?.let { product ->
                ...
                itemView.editGiftEnable.setOnClickListener {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ProductViewHolder {
        val view =
            LayoutInflater.from(parent.context).inflate(R.layout.item_cart_per_countery, parent, false)
